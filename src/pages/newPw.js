    ...
    return (
      <Layout>
        <div class="accountsContainer">
          <div class="form">
            <p class="loginHeader">Agregar nueva cuenta y contraseña</p>
            <p class="accountsSubHeader">
              Ingresa el usuario que quieres añadir junto con la contraseña.
            </p>
            <FormStyles>
              <Form
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <label>
                      ...
                      <div class="rowCustomAccounts centerFlex m0">
                        <button class = "loginButton" type="button" onClick={this.generatePW}>
                          Generar Contraseña
                        </button>
                      </div>
                    </label>
